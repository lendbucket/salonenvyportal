...
export default function ComplaintsPage() {
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-8">
      <h1 className="font-[var(--font-noto-serif)] text-3xl text-white">Anonymous Complaints</h1>
      <div className="bg-[#1f2c31] border border-[rgba(205,201,192,0.15)] rounded-xl p-10 text-center space-y-4">
        <span className="material-symbols-outlined text-5xl text-[#CDC9C0]/30">shield</span>
